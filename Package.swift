...
var platforms: [SupportedPlatform] = [
	...
	.tvOS("11"), // SwiftUI requires 13; newer UI APIs remain availability-gated.
	.watchOS("4"), // SwiftUI requires 6; newer UI APIs remain availability-gated.
]
...
#else
platforms += [
	// The former iOS 11 floor came from APIs that now have legacy fallbacks. UI and concurrency
	// remain availability-gated (13 minimum for Combine/SwiftUI); Date uses nowBackport.
	.iOS("8"),
]
#endif
...
targets += [
	.executableTarget(
		...
		path: "Development"
		,exclude: ["Resources", "CompatibilityTests", "CompatibilitySwiftPMTests", "compatibilityCLI", "LegacyTests"]
